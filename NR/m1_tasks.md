...
- [x] 4. Run `example_adaptive_grid.py`, document refinement APIs
...
- Warp 1.10.1 installed and tested
- Ran 3+ FEM examples (diffusion, Navier-Stokes, adaptive grid)
- Documented APIs in NR/refs/
- Implemented working Poisson solver (src/poisson_solver.py)
- Verification tests pass with < 1e-4 error (tests/test_poisson_verification.py)
